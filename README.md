...
### IPython Notebook
For detailed walkthroughs and explanations of the training process and results, refer to the IPython Notebook files [COMP6721_Venue_Classification.ipynb](COMP6721_Venue_Classification code.ipynb).
